        ...
        <div className="flex items-center justify-between min-h-[96px] sm:min-h-[110px] py-2">
          ...
          <div className="hidden md:block">
            <a href={`https://wa.me/541122966242?text=Hola%20que%20tal,%20vengo%20de%20la%20pagina%20web,%20me%20interesa%20mas%20informacion%20sobre%20fardos%20disponibles`} 
              ...
              className="flex items-center gap-2 border border-[#E05C4F] text-stone-200 hover:bg-[#E05C4F] hover:text-stone-950 text-xs font-black uppercase tracking-widest px-6 py-3 rounded transition-all">
